                            ...
                            <tr>
                                <td class="esd-block-text es-p25t es-p40r es-p40l" align="justify">
                                    ...
                                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                        style="margin:0; padding-left:25px; padding-right:25px; padding-top:25px;">
                                        <tr>
                                            <td align="center">

                                                <!--[if mso]>
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                    href="{{ $data['linkAcceso'] }}"
                                                    style="height:44px;v-text-anchor:middle;width:240px;"
                                                    arcsize="8%" strokecolor="#0d6efd" fillcolor="#0d6efd">
                                                    <w:anchorlock/>
                                                ...
                                                <a href="{{ $data['linkAcceso'] }}" target="_blank" rel="noopener noreferrer"
                                                    style="background:#0d6efd;border:1px solid #0d6efd;border-radius:6px;
                                                ...
                                                <div style="font-size:12px;line-height:1.5;color:#6c757d;margin-top:10px;">
                                                    ...
                                                    <a href="{{ $data['linkAcceso'] }}" target="_blank"
                                                       rel="noopener noreferrer" style="color:#0d6efd;">
                                                       {{ $data['linkAcceso'] }}
                                                    </a>
                                                </div>
