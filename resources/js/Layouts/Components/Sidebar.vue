<template>
    ...
    <div class="contenedor-sidebar d-flex flex-column" id="sidebar-layout">
        ...
        <div class="head title-sidebar" id="title-sidebar">
            <img src="/images/sdp_logo.png" id="title1" width="180" height="40" />
            <img src="/images/sdp_logo_cabecera.png" id="title2" class="text-end col-md-4 d-none" width="70" />
        </div>

        <div class="mx-2 mt-3 user-section">
            <span class="d-flex image-url">
                <img class="rounded-circle" :src="this.$page.props.auth.user.avatar" alt=""
        ...
        <nav class="mb-auto">
            <ul class="mcd-menu">
                <div>
                    <!-- TODO CHILE PERU  -->
                    <div class="solicitudes-planta" v-if="
                    ...
                    ">
                        <li class="toogle-li" v-if="this.$page.props.auth.user.pais == 'PE'">
                            <a :href="this.route('redirect.colaboradores.pe')" :class="(this.route().current(
                        ...
                        <li class="toogle-li" v-if="this.$page.props.auth.user.pais == 'CL'">
                            <a :href="this.route('redirect.colaboradores.cl')" :class="(this.route().current(
                        ...
                        <li class="toogle-li">
                            <a :href="this.route('redirect.solicitud')" :class="(this.route().current('redirect.solicitud')
                                ? 'active'
                                : '') + ' d-flex align-items-center'
                                " @click="setPreloader()">
                    ...
                    <!-- TODO OBRA -->
                    <div class="solicitudes-obra" v-if="
                        this.$page.props.permisos.includes(
                            this.$env.LIDEROBRACL
                        )
                    ">
                        <li class="toogle-li">
                            <a :href="this.route('redirect.colaboradores.obra.cl')
                        ...
                        <li class="toogle-li">
                            <a :href="this.route('redirect.solicitud.obra')" :class="(this.route().current(
                    ...
                    ">
                        <li class="toogle-li">
                            <a :href="this.route('redirect.solicitud.aprobar')" :class="(this.route().current(
                    ...
                    ">
                        <li class="toogle-li">
                            <a :href="this.route('redirect.solicitud.rrhh')" :class="(this.route().current(
                    ...
                    ">
                        <li class="toogle-li">
                            <a :href="this.route('redirect.calendar')" :class="(this.route().current(
                                'redirect.calendar'
                            )
                                ? 'active'
                                : '') + ' d-flex align-items-center'
                    ...
                    ">
                        ...
                        <ul>
                            ...
                            <li>
                                <a :href="this.route('redirect.usuarios')" :class="this.route().current(
                                    'redirect.usuarios'
                                )
                                    ? 'active'
                                    : ''
                ...
                <div>
                    ...
                    ">
                        <a :href="this.route('redirect.solicitud.area')" :class="this.route().current('redirect.solicitud.area')
                            ? 'active'
                            : ''
        ...
        <div class="text-center mt-auto p-5" id="button-logout-block" @click="logout">
            <a class="btn btn-outline-secondary" role="button">Cerrar sesión</a>
        </div>
        <div class="head title-sidebar mt-auto pb-5 d-none" id="button-logout" @click="logout">
            <h5 class="col-md-7 text-white">Button logout</h5>
            <strong class="text-end col-md-3 button-logout-icon"><i class="fas fa-sign-out-alt"></i></strong>
        </div>
    </div>
</template>
<script>
